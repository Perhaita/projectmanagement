...
let empFromLocalStorage = localStorage.getItem("employeesArr");
let employeesArr;


function initStorage() {
  if (empFromLocalStorage != null ) {
...
function createRow(person, i) {
  ...
  rowStr +=
    '<td><button class="editButton" onclick="editEmp(' +
    i +
    ')">Edit</button><button class="deleteButton" onclick="deleteEmp(' +
    i +
    ')">Del</button></td>';
  rowStr += "</tr>";
  return rowStr;
