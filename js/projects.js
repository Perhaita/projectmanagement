...
function createTable() {
  if (projectsArr && projectsArr.length === 0) {
    ...
    let tableStr =
      "<tr><th>No.</th><th>Prj name</th><th>Start date</th><th>Duration (months)</th><th>Emp needed</th><th>Emp working</th><th>Actions</th></tr>";
...
function createRow(project, i) {
  ...
  rowStr +=
    '<td><button class="editButton" onclick="editPrj(' +
    i +
    ')">Edit</button><button class="deleteButton" onclick="deletePrj(' +
    i +
    ')">Del</button></td>';
  rowStr += "</tr>";
  return rowStr;
